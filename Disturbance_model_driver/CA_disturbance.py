...
this driver simulates grazing and fire disturbance on flat domain
it uses the rainfall files provided 
"""
...
#instantiate ecohydrologic functions and 
...
veg_cov = np.zeros([n_years, 6])                        # why are we adding this..?
...
precip = P_factor*np.load('precip_flt_31_lnger.npy')
